...
import cho.chonotes.framework.presentation.TestNoteFragmentFactory
import cho.chonotes.framework.presentation.UIController
import cho.chonotes.framework.presentation.notelist.NoteListAdapter.NoteViewHolder
...
class NoteListFragmentTests: BaseTest() {
    ...
    fun generalListFragmentTest() = runBlocking{
        ...
        val randomNote = testEntityList[Random.nextInt(0, testEntityList.size-1)]
